...
demo.level1.prototype = {
	preload: function(){
        ...
        game.load.image('Tiles', 'assets/backgrounds/protoTileSet.png');
        game.load.image('Trash', 'assets/sprites/paperBall.png'); // for now
        
        game.load.spritesheet('villain', 'assets/sprites/villainSpritesheet.png', 300, 300);
        game.load.spritesheet('jan', 'assets/sprites/characterSpritesheet.png', 230, 405);
